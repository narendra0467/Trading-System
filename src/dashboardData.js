...
export function buildDashboardData({ reportsDir, dataDir, updatedAt = new Date().toISOString() }) {
  return {
    ...
    leapsAlerts: readJson(reportsDir, "latest_leaps_alerts.json", []),
    leapsReport: readJson(reportsDir, "latest_leaps_report.json", null),
    ...
    hiddenMultibagger: readJson(reportsDir, "hidden_multibagger_discovery_scanner.json", null),
    ...
    leapsScan: readCsv(reportsDir, "latest_leaps_scan.csv"),
